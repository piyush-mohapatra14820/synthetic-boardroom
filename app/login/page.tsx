  ...
  return (
    <main className="wood-grain min-h-screen flex items-center justify-center px-6 relative z-10 overflow-x-hidden">
      <div className="w-full max-w-sm relative z-10 fade-up text-center">
        <div className="mb-3">
          <span className="text-[#5c0403]/70 text-xs uppercase tracking-[0.3em]" style={PLAYFAIR}>
            Private Beta
          </span>
        </div>
        <h1 className="text-[clamp(2.5rem,11vw,4.5rem)] text-[#1a0e08] leading-none mb-1" style={OSWALD}>
          SYNTHETIC
        </h1>
        <h1 className="text-[clamp(2.5rem,11vw,4.5rem)] text-[#5c0403] leading-none mb-6" style={OSWALD}>
          BOARDROOM
        </h1>
        ...
        <p className="text-[#5c3010]/60 text-xs mt-6" style={PLAYFAIR}>
